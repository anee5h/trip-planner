...
function ensureProvenance(id: string, sources: SourceDef[], summary: string) {
  patch(
    ...
    (d) => {
      ...
      // Robust idempotence: drop ANY existing entry for this summary+date,
      // then append exactly one. Deduping only the last entry allowed earlier
      // double-appends to persist.
      const deduped = changes.filter(
        (c) => !(c.summary === summary && c.changedAt === AUDIT_DATE),
      );
      d.editorial = {
        ...(d.editorial ?? {}),
        lifecycle,
...
patch(
  ...
  (d) => {
    ...
    d.businessHours = "Open access (open-air ponds; 3.6 km one-way trail)";
  },
...
patch(
  ...
  (d) => {
    ...
    d.businessHours = "09:00 - 18:00 (Sep–Apr) / 09:00 - 19:00 (May–Aug)";
    d.openingHoursMetadata = {
      verifiedAt: AUDIT_DATE,
...
patch(
  ...
  (d) => {
    d.kind = "castle";
    d.coordinates = { lat: 38.253418, lng: 140.856766 };
    d.notes =
...
const OPENING_HOURS_JA_TOHOKU: Record<string, string> = {
  ...
  "sazae-do": "4～11月は8:15～日没、12～3月は9:00～16:00。拝観料400円。",
  ...
  "asamushi-onsen":
    "温泉街は常時散策可。足湯は無料。各旅館の日帰り入浴時間は施設により異なります。",
  ...
  "saisho-in":
    "境内は9:00～16:30。通常無料（桜・ねぷた・菊もみじ時期は入場料あり）。",
  "iwate-park-morioka-castle-ruins": "公園は常時開園。入園無料。",
  "bank-of-iwate-red-brick":
    "9:30～17:00。月曜休館（祝日の場合は翌日）、年末年始休館。",
  "morioka-handiworks-square":
    "9:00～17:00。年中無休（12月31日～1月2日を除く）。",
  "koiwai-farm": "9:00～17:00（時期により変動）。12月～2月は土日祝のみ営業。",
  "motsu-ji":
    "8:30～17:00（3月1日～11月3日）、8:30～16:30（冬季）。拝観料大人500円。",
  "takkoku-no-iwa": "8:00～17:00。拝観料大人400円。",
  "iizaka-onsen":
    "温泉街は常時散策可。共同浴場の営業時間は施設により異なります。",
  "fukushima-prefectural-museum-of-art":
    "9:30～17:00（最終入館16:30）。月曜休館（祝日の場合は翌日）。",
...
function tohokuPoi(
  ...
  if (Math.abs(sum - budget[1]) > Math.max(100, budget[1] * 0.02)) {
    throw new Error(
      `${id}: budget breakdown sum ${sum} != recommended ${budget[1]}`,
    );
  }
...
const MATSUSHIMA_IMAGE = {
  zuiganji: {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:211030_Zuigan-ji_Matsushima_Miyagi_pref_Japan10s3.jpg",
  },
  godaido: {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Matsushima_Godaido_4.jpg",
  },
  kanrantei: {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Matsushima_Kanran-tei_01.jpg",
  },
  fukuurajima: {
    ...
    attribution: "Wikimedia Commons",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Fukuura_Bridge_With_Fukuura_Island.JPG",
  },
  oshima: {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:雄島_Oshima_Island_-_panoramio.jpg",
  },
  entsuin: {
  ...
  cruise: {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Flag_of_Japan,_sightseeing_boat_on_Matsushima_Bay_-_Oct_25,_2022_(1).jpg",
  },
  saigyo: {
    ...
    attribution: "663highland",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:211030_Saigyo_Modoshi_no_Matsu_Park_Matsushima_Miyagi_pref_Japan01n.jpg",
  },
  townHall: {
    ...
    attribution: "Wikimedia Commons",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Matsushima_Town-Hall.jpg",
  },
};
...
const MATSUSHIMA_POIS: Destination[] = [
  tohokuPoi(
    ...
    [
      ...
      "Date Masamune's rebuilt temple",
      "Gold-leaf Momoyama interiors",
      "Cave shrines of Oshu",
    ],
    [1000, 3000, 5000],
  ...
  tohokuPoi(
    ...
    [
      "Islet hall on red bridges",
      "12 zodiac carvings",
      "Bay symbol of Matsushima",
      "Free to visit",
    ],
    [0, 1500, 3000],
    ...
    [
      {
        ...
        title: "Matsushima tourism association — Godaido",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "Tea pavilion from Fushimi-Momoyama",
      "Matsushima Museum",
      "Matcha with a bay view",
      "Prefecture cultural property",
    ],
    [300, 2000, 4000],
    ...
    [
      {
        type: "government",
        url: "https://www.town.miyagi-matsushima.lg.jp/page/1140.html",
        title: "Matsushima Town — Kanrantei",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      {
        type: "government",
        url: "https://www.town.miyagi-matsushima.lg.jp/page/1578.html",
        title: "Matsushima Town — Fukuura Island",
      },
    ],
    ...
    [
      {
        ...
        title: "Matsushima tourism association — Oshima",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "Rose and moss gardens",
      "San'e-den (Important Cultural Property)",
      "Bead-stringing experience",
      "Autumn maple illuminations",
    ],
    [500, 2400, 4000],
    ...
    [
      {
        type: "official",
        url: "https://www.entuuin.or.jp",
        title: "Entsu-in official site",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      ...
      "Routes through 30+ islands",
      "Nihon Sankei from the water",
      "Hourly departures",
    ],
    [1500, 4000, 7000],
    ...
    [
      {
        type: "official",
        url: "https://www.matsushima.or.jp/timesheet/",
        title: "Matsushima sightseeing boat union — timetable",
      },
    ],
  ...
  tohokuPoi(
    ...
    "https://www.matsushima-kanko.com/",
    "Park freely walkable; Panorama Line road closed in winter",
    "No reservation required",
    ...
    [
      {
        ...
        title: "Matsushima tourism association — Saigyo Modoshi no Matsu Park",
      },
    ],
...
const AOMORI_GROUP_IMAGE: Record<
  string,
  { url: string; license: string; attribution: string; sourceUrl: string }
> = {
  "aomori-museum-of-art": {
    ...
    attribution: "663highland",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:140913_Aomori_Museum_of_Art_Japan02bs3.jpg",
  },
  "mount-hakkoda-ropeway": {
    ...
    attribution: "Marho",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Hakkoda_Ropeway_2019.jpg",
  },
  "asamushi-onsen": {
    ...
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Asamushi_hot_spring_and_Yonoshima_island_aerial_photo.jpg",
  },
  "kabushima-shrine": {
  ...
  "tatehana-wharf-morning-market": {
    ...
    attribution: "くろふね",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:館鼻岸壁朝市（八戸市）20250928-P1073508.jpg",
  },
  "towada-art-center": {
  ...
  "fujita-memorial-garden": {
    ...
    attribution: "掬茶",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:Fujita_Memorial_Garden_in_June_2022_(2).jpg",
  },
  "saisho-in": {
    ...
    attribution: "663highland",
    sourceUrl:
      "https://commons.wikimedia.org/wiki/File:191208_Saishoin_Hirosaki_Aomori_pref_Japan02s3.jpg",
  },
};
...
const AOMORI_GROUP_POIS: Destination[] = [
  tohokuPoi(
    ...
    [
      "Nara Yoshitomo's white dog",
      "Chagall's 'Aleko' backdrops",
      "Munakata Shiko collection",
      "Beside the Jomon site",
    ],
    [700, 2800, 5000],
    ...
    [
      {
        ...
        title: "Aomori Museum of Art official site",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "Winter juhyo ice monsters",
      "Summit walking loops",
      "Alpine flowers and autumn colour",
      "Near Sukayu Onsen",
    ],
    [2500, 5000, 8000],
    ...
    [
      {
        ...
        title: "Hakkoda Ropeway official site",
      },
    ],
    ...
    [
      {
        ...
        title: "Asamushi Onsen Tourism Association",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "Black-tailed gull rookery",
      "National Natural Monument",
      "Fortune-bringing shrine",
      "Island shrine by the sea",
    ],
    [0, 1500, 3000],
    { transport: 800, tickets: 0, food: 500, cafe: 200 },
    ...
    [
      {
        ...
        title: "Visit Hachinohe — Kabushima Shrine",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      {
        type: "tourism_board",
        url: "https://visithachinohe.com/stories/tatehanaganpeki-asaichi/",
        title: "Visit Hachinohe — Tatehana Wharf Asaichi",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "Kusama outdoor sculpture",
      "Ron Mueck's Standing Woman",
      "Nara Yoshitomo",
      "Town-wide art project",
    ],
    [1000, 4000, 7000],
    ...
    [
      {
        ...
        title: "Towada Art Center official site",
      },
    ],
    ...
    [
      {
        ...
        title: "Tsugaru-han Neputa-mura official site",
      },
    ],
    ...
    [
      {
        ...
        title: "Hirosaki Tourism Association — Fujita Memorial Garden",
      },
    ],
  ...
  tohokuPoi(
    ...
    [
      "ICP five-story pagoda",
      "Built 1667",
      "Samurai-district anchor",
      "Free normally",
    ],
    [0, 1500, 3000],
    ...
    [
      {
        type: "official",
        url: "https://saisyouin.jp/",
        title: "Saisho-in official site",
      },
    ],
...
const MORIOKA_POIS: Destination[] = [
  tohokuPoi(
    ...
    [
      "One of Japan's 100 Castles",
      "Granite stone walls",
      "Honmaru views",
      "Sakura and autumn colour",
    ],
    [0, 1500, 3000],
    { transport: 700, tickets: 0, food: 500, cafe: 300 },
    ...
    ],
    {
      ...
      attribution: "663highland",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:171103_Morioka_Castle_Morioka_Iwate_pref_Japan20s3.jpg",
    },
  ),
  tohokuPoi(
    "bank-of-iwate-red-brick",
    ...
    [
      {
        ...
        title: "Bank of Iwate Red Brick Building official site",
      },
    ],
    {
      ...
      attribution: "663highland",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:171103_Former_Morioka_Bank_Head_Office_Morioka_Iwate_pref_Japan01bs5.jpg",
    },
  ),
  tohokuPoi(
    "morioka-handiworks-square",
    ...
    [
      {
        type: "official",
        url: "https://tezukurimura.com/",
        title: "Morioka Handi-Works Square official site",
      },
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Morioka_Handi-Works_Square_20170715a.jpg",
    },
  ),
  tohokuPoi(
    "koiwai-farm",
    ...
    [
      "One-row cherry trees and Mt Iwate",
      "Ranch experiences",
      "Dairy products",
      "Old stone barn",
    ],
    ...
    [
      {
        ...
        title: "Koiwai Farm official site",
      },
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Cherry_tree_and_Mount_Iwate.jpg",
    },
  ),
];
...
const TOHOKU_EAST_POIS: Destination[] = [
  tohokuPoi(
    ...
    ],
    {
      ...
      attribution: "663highland",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:230728_Motsuji_Hiraizumi_Iwate_pref_Japan37s3.jpg",
    },
  ),
  tohokuPoi(
    "takkoku-no-iwa",
    ...
    [
      {
        ...
        title: "Takkoku-no-Iwa official site",
      },
    ],
    {
      ...
      attribution: "663highland",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:230728_Takkoku-no-iwaya_Bishamondo_Hiraizumi_Iwate_pref_Japan01s3.jpg",
    },
  ),
  tohokuPoi(
    "iizaka-onsen",
    ...
    [
      "Japan's oldest wooden bathhouse",
      "Communal bath circuit",
      "Riverside onsen town",
      "~1,200-year history",
    ],
    [400, 2500, 5000],
    ...
    "https://iizaka.com/",
    "Sakaba-yu 06:00–21:00 (last entry 20:40), closed Mondays; the district is freely walkable otherwise",
    ...
    [
      {
        ...
        title: "Iizaka Onsen official site",
      },
    ],
    {
      ...
      attribution: "Abasaa",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Iizaka_Onsen_Hakoyu.JPG",
    },
  ),
  tohokuPoi(
    "fukushima-prefectural-museum-of-art",
    ...
    [
      {
        ...
        title: "Fukushima Prefectural Museum of Art official site",
      },
    ],
    {
      ...
      attribution: "Hasec",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Fukushima-Pref-Museum-of-Art02.jpg",
    },
  ),
  tohokuPoi(
    "oga-namahage-kan",
    ...
    [
      ...
      "~150 masks and costumes",
      "Live performances",
      "Beside Shinzan Shrine",
    ],
    [660, 3500, 6000],
    ...
    [
      {
        ...
        title: "Namahage-kan official site",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Entrance_of_Namahage_Museum,_Oga,_Akita.JPG",
    },
  ),
  tohokuPoi(
    "akita-senshu-park",
    ...
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Kogetsu-pond_in_Senshu_Park_20180520.jpg",
    },
  ),
  tohokuPoi(
    "akita-museum-of-art",
    ...
    [
      ...
      "Fujita's 'Akita's Festivals' mural",
    ...
    [
      {
        ...
        title: "Akita Museum of Art official site",
      },
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Akita_Museum_of_Art_20180520.jpg",
    },
  ),
];
    ...
    [
      {
        ...
        title: "Sendai City — Yagiyama Zoological Park",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:八木山動物公園_Yagiyama_Zoological_Park_(55089719967).jpg",
    },
  ),
  tohokuPoi(
    "sendai-ichibancho",
    ...
    [
      "Six covered arcades",
      "Tohoku's first arcade",
      "Tanabata Festival venue",
      "Shopping and dining",
    ],
    [0, 3000, 6000],
    { transport: 800, tickets: 0, food: 1400, cafe: 800 },
    ...
    [
      {
        type: "tourism_board",
        url: "https://www.sentabi.jp/en/spots/324",
        title: "Sendai Tourism — Ichibancho",
      },
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Sun_Mall_Ichibancho_202209.jpg",
    },
  ),
  tohokuPoi(
    "sendai-daikannon",
    ...
    [
      {
        type: "official",
        url: "https://www.daikannon.com/",
        title: "Sendai Daikannon official site",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Sendai_Daikannon_(1870523730).jpg",
    },
  ),
  tohokuPoi(
    "yamagata-bunshokan",
    ...
    [
      "Taisho-era Western building",
      "Clock tower and stained glass",
    ...
    [
      {
        ...
        title: "Yamagata Bunshokan official site",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Bunshokan,_Yamagata_20170401-3.jpg",
    },
  ),
  tohokuPoi(
    "kajo-park",
    ...
    [
      {
        type: "government",
        url: "https://www.city.yamagata-yamagata.lg.jp/kurashi/koen/1006541/1006544/1003675.html",
        title: "Yamagata City — Kajo Park",
      },
    ],
    {
      ...
      attribution: "663highland",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:220430_Yamagata_Castle_Yamagata_Yamagata_pref_Japan01s3.jpg",
    },
  ),
  tohokuPoi(
    "kaminoyama-castle-town",
    ...
    [
      "Reconstructed keep and museum",
      "1,200-year onsen town",
      "Footbath circuit",
      "Shinkansen stop nearby",
    ],
    [600, 2500, 5000],
    ...
    [
      {
        ...
        title: "Kaminoyama Castle official site",
      },
    ],
    {
      ...
      attribution: "掬茶",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Kaminoyama_Castle_20230806b.jpg",
    },
  ),
  tohokuPoi(
    "aizu-bukeyashiki",
    ...
    [
      "Rebuilt Saigo Tanomo residence",
      "Relocated Edo buildings",
    ...
    [
      {
        type: "official",
        url: "https://bukeyashiki.com/",
        title: "Aizu Bukeyashiki official site",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Aizu_Bukeyashiki_Garden.jpg",
    },
  ),
  tohokuPoi(
    "nisshinkan",
    ...
    [
      "Full-scale clan school reconstruction",
      "Confucius hall",
      "Japan's oldest pool",
      "Byakkotai heritage",
    ],
    ...
    [
      {
        type: "official",
        url: "https://www.nisshinkan.co.jp/",
        title: "Nisshinkan official site",
      },
    ],
    {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Nisshinkan_Samurai_School_exterior_in_2013-10-18.jpg",
    },
  ),
  tohokuPoi(
    "sazae-do",
    ...
    [
      "World's only double-helix building",
      "Built 1796",
      "National Important Cultural Property",
      "Beside the Byakkotai graves",
    ],
    [400, 2000, 3500],
    ...
    ],
    {
      ...
      attribution: "Kounosu",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Sazaedou_Aidu_Japan01.jpg",
    },
  ),
  tohokuPoi(
    "kitakata-kura-district",
    ...
    "Kura no Sato 09:00 - 17:00 (last entry 16:30), closed year-end; the town streets are freely walkable",
    "No reservation required",
    ...
    [
      {
        type: "tourism_board",
        url: "http://www.furusatosinkou.co.jp/sato/",
        title: "Kura no Sato official site",
      },
    ],
    {
      ...
      attribution: "contri",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:土蔵_(1389928661).jpg",
    },
  ),
];
...
const HUB_NOTES_JA: Record<string, string> = {
  "aomori-city":
    "ねぶた祭りの拠点となる港町。青森駅周辺は徒歩圏で、北海道へのフェリーも発着します。",
  "hirosaki-city": "弘前城と春の桜で知られる城下町。津軽地方の拠点です。",
  "hachinohe-city":
    "太平洋側の港町で、三陸海岸と朝市文化の拠点。東北新幹線の終端に近い。",
  "akita-city": "日本海側の秋田県都。竿燈まつりと千秋公園で知られます。",
  "semboku-city": "角館の武家屋敷、田沢湖、乳頭温泉郷を擁する内陸の市。",
  "morioka-city":
    "北上川と中津川が合流する城下町。東北新幹線で岩手の中心部へ。",
  "sendai-city":
    "東北最大の都市。伊達家の城下町の歴史と活気ある食文化、新幹線の要衝です。",
  "yamagata-city": "山形県の県都。山寺や蔵王方面への旅の拠点です。",
  "aizuwakamatsu-city":
    "会津藩の歴史を伝える城下町。鶴ヶ城と武士の文化で知られます。",
  "fukushima-city": "山あいの盆地に広がる福島県都。果物と温泉街で知られます。",
  "koriyama-city":
    "福島県中央部の交通・商業の要衝。猪苗代湖や磐梯方面へのアクセス拠点です。",
};
...
patch(
  ...
  (d) => {
    ...
    d.imageMetadata = {
      ...
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Sendai_Asaichi_01.jpg",
    };
  },
...
const OPEN_AIR_HOURS: Record<string, string> = {
  "dewa-sanzan-yamagata":
    "Mountain pilgrimage; Gassan climbable only in summer",
  "ginzan-onsen-yamagata": "Onsen town; ryokan day-use hours vary by inn",
  "hirosaki-castle":
    "Park freely walkable; the keep interior is closed for seismic repair (since Nov 2025)",
  "jodogahama-beach-iwate":
    "Beach freely accessible; visitor-centre hours vary by season",
  "lake-towada-aomori":
    "Lake freely accessible; cruises and visitor centres have their own hours",
  "mount-zao-yamagata": "Mountain; ropeway hours and winter access vary",
  "oirase-gorge-aomori":
    "Stream trail freely walkable; shuttle bus runs seasonally",
  "okama-crater-yamagata":
    "Crater walkable when accessible; Zao Echo Line road closed Nov–Apr",
  "ouchi-juku-fukushima":
    "Post town freely walkable; individual museums have their own hours",
  "shirakami-sanchi-aomori": "Forest; trail access typically Jun–Oct",
...
// ===========================================================================
// SYNC_LIFECYCLE_STATUS_MISMATCH: records with a published editorial
// lifecycle must carry status "published" (catalogue-integrity E6).
// ===========================================================================

const PUBLISHED_STATUS_IDS = [
  "aizuwakamatsu-city",
  "akita-city",
  "aomori-city",
  "fukushima-city",
...
for (const id of PUBLISHED_STATUS_IDS) {
  patch(
    id,
    (d) => {
      d.status = "published";
    },
    "status published (matches published editorial lifecycle)",
  );
}
