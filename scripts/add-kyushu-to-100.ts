...
const POI_CAPE_TOI: PoiInput = {
  ...
  kind: "natural",
  categories: ["Nature", "Outdoor"],
  tags: ["Cape", "Wild Horses", "Lighthouse", "Nichinan City"],
  coordinates: { lat: 31.3667, lng: 131.3333 },
  description:
    "A scenic cape at the southern tip of Miyazaki Prefecture known for its population of semi-wild Misaki horses, which have roamed freely here for over 300 years. Features a prominent white lighthouse and stunning ocean views.",
  descriptionJa:
    "宮崎県最南端に位置する景勝地。約300年前から野生馬（御崎馬）が生息していることで知られています。白亜の灯台や太平洋の絶景が楽しめます。",
  highlights: [
    "Observe the semi-wild Misaki horses grazing freely",
    "Panoramic views of the Pacific Ocean from the cape",
    "Visit the historic Cape Toi Lighthouse",
  ],
  highlightsJa: [
    "野生の御崎馬が草を食む姿を観察",
    "太平洋を見渡す絶景パノラマ",
  ...
  heroImage:
    "https://upload.wikimedia.org/wikipedia/commons/4/44/Toimisaki_Lighthouse_%288727895451%29.jpg",
  imageAttribution: "hiroaki",
  imageLicense: "CC BY 2.0",
  imageSourceUrl:
    "https://commons.wikimedia.org/wiki/File:Toimisaki_Lighthouse_(8727895451).jpg",
  openingHours: "Open 24 hours. Lighthouse open 09:00 - 16:30.",
  openingHoursJa: "24時間開放。灯台は09:00〜16:30。",
  hoursSourceUrl: "https://kushima-city.jp/toi/",
  officialWebsite: "https://kushima-city.jp/toi/",
  wikiUrl: "https://en.wikipedia.org/wiki/Cape_Toi",
  wikiTitle: "Cape Toi",
  budgetMin: 500,
  ...
  weatherDependence: "high",
  reservation: "None required",
  parking: "Paid parking available at the cape entrance",
  walkingIntensity: "low",
  walkingSunMin: 1500,
  walkingShadeMin: 500,
  comfort: { heatTolerance: 7, rainFriendly: 2, walkingIntensity: 3 },
  notes: "A toll fee of 400 yen per car applies at the entrance gate.",
  notesJa: "入り口ゲートで車1台につき400円の協力金が必要です。",
};
...
const POI_ONTA_POTTERY: PoiInput = {
  id: "onta-pottery-village",
  name: "Onta Pottery Village",
  nameJa: "小鹿田焼の里",
  parentId: "hita-city",
  prefecture: "Oita",
  municipalityId: "Oita:hita",
  ...
  tags: ["Pottery", "Traditional Craft", "Village", "Hita City"],
  coordinates: { lat: 33.4072, lng: 130.9328 },
  description:
    "A small, secluded pottery village in the mountains of Hita where traditional Onta ware (Onta-yaki) has been produced for over 300 years using water-powered clay crushers. Designated as an Intangible Cultural Property.",
  descriptionJa:
    "日田市の山あいに位置する小さな陶芸の里。300年以上にわたり、川の水力を利用した唐臼で土を砕き、伝統的な小鹿田焼（おんたやき）を作り続けています。国の重要無形文化財に指定。",
  highlights: [
    "Hear the rhythmic sounds of water-powered clay crushers",
    "Purchase handmade Onta ware directly from local kilns",
    "Explore the preserved traditional mountain village atmosphere",
  ],
  highlightsJa: [
    "川の水力を利用した唐臼の音色",
    "窯元で直接手作りの小鹿田焼を購入",
  ...
  heroImage:
    "https://upload.wikimedia.org/wikipedia/commons/b/b9/Onta_Pottery_Village_01.jpg",
  imageAttribution: "STA3816",
  imageLicense: "CC BY-SA 3.0",
  imageSourceUrl:
    "https://commons.wikimedia.org/wiki/File:Onta_Pottery_Village_01.jpg",
  openingHours:
    "Open 24 hours (village access); Kiln shops generally open 09:00 - 17:00.",
  openingHoursJa: "24時間開放（集落）。窯元の店舗は概ね09:00〜17:00。",
  hoursSourceUrl: "https://oidehita.com/archives/51821",
  officialWebsite: "https://oidehita.com/archives/51821",
  wikiUrl: "https://en.wikipedia.org/wiki/Onta_ware",
  wikiTitle: "Onta ware",
  budgetMin: 500,
  budgetRecommended: 3000,
  budgetMax: 10000,
  ticketCost: 0,
  transportOptions: { bus: 500 },
  totalTripHours: 4,
  recommendedVisitHours: { min: 1.5, max: 3 },
  walkingMin: 3000,
  indoorPercent: 20,
  ...
  season: { spring: 9, summer: 8, autumn: 9, winter: 7 },
  bestMonths: [3, 4, 5, 9, 10, 11],
  weatherDependence: "medium",
  reservation: "None required",
  parking: "Free public parking available near the village entrance",
  walkingIntensity: "low",
  walkingSunMin: 1500,
  walkingShadeMin: 1500,
  comfort: { heatTolerance: 8, rainFriendly: 5, walkingIntensity: 3 },
  notes:
    "The village is small and quiet; please respect the privacy of the potters who live and work here.",
  notesJa:
    "静かな集落ですので、作業中の職人や住民のプライバシーにご配慮ください。",
};

const POI_HITA_ONSEN: PoiInput = {
  id: "hita-onsen",
  name: "Hita Onsen & Mikuma River",
  nameJa: "日田温泉・三隈川",
  parentId: "hita-city",
  prefecture: "Oita",
  municipalityId: "Oita:hita",
  kind: "onsen",
  categories: ["Onsen", "Leisure"],
  tags: ["Onsen", "Riverfront", "Houseboats", "Hita City"],
  coordinates: { lat: 33.3155, lng: 130.9351 },
  description:
    "A historic hot spring resort situated along the serene Mikuma River. Famous for its summer houseboats (yakatabune) where visitors can enjoy dinner on the water while watching traditional cormorant fishing (ukai).",
  descriptionJa:
    "三隈川沿いに旅館が立ち並ぶ歴史ある温泉地。夏場の屋形船が名物で、水上での食事や伝統的な鵜飼い見学が楽しめます。",
  highlights: [
    "Relax in soothing hot springs with river views",
    "Experience traditional cormorant fishing from a houseboat (summer)",
    "Enjoy scenic walks along the Mikuma River promenade",
  ],
  highlightsJa: [
    "三隈川を望む温泉でリラックス",
    "屋形船からの鵜飼い見学（夏季）",
  ...
  heroImage:
    "https://upload.wikimedia.org/wikipedia/commons/6/65/Mikuma_River_and_Hita_Onsen.jpg",
  imageAttribution: "STA3816",
  imageLicense: "CC BY 3.0",
  imageSourceUrl:
    "https://commons.wikimedia.org/wiki/File:Mikuma_River_and_Hita_Onsen.jpg",
  openingHours:
    "Open 24 hours for riverside area; Onsen bath and ryokan hours vary.",
  openingHoursJa:
    "川沿いは24時間開放。各旅館・立ち寄り湯の営業時間は異なります。",
  hoursSourceUrl: "https://oidehita.com/archives/51871",
  officialWebsite: "https://oidehita.com/archives/51871",
  wikiUrl: "https://ja.wikipedia.org/wiki/%E6%97%A5%E7%94%B0%E6%B8%A9%E6%B3%89",
  wikiTitle: "日田温泉",
  budgetMin: 500,
  budgetRecommended: 2000,
  budgetMax: 20000,
  ticketCost: 0,
  transportOptions: { walk: 15 },
  totalTripHours: 3,
  recommendedVisitHours: { min: 2, max: 4 },
  walkingMin: 2000,
  indoorPercent: 50,
  ...
  weatherDependence: "medium",
  reservation: "Recommended for houseboats and ryokan stays",
  parking: "Available at individual ryokans and some public lots",
  walkingIntensity: "low",
  walkingSunMin: 1000,
  walkingShadeMin: 1000,
  comfort: { heatTolerance: 8, rainFriendly: 7, walkingIntensity: 2 },
  notes:
    "Cormorant fishing (ukai) season typically runs from late May to October.",
  notesJa: "鵜飼いのシーズンは通常5月下旬から10月末までです。",
};
...
const HITA_POIS = [
  ...
  buildPoi(POI_ONTA_POTTERY),
  buildPoi(POI_HITA_ONSEN),
...
function validateRecords(records: DestinationRecord[], stage: string) {
  ...
  for (const r of records) {
    ...
    const KNOWN_BAD: Record<string, string> = {
      ...
      "onta-pottery-village": "Oyama_Dam_Attack_on_Titan_statues",
