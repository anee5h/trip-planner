...
const POI_HORIKAWA_CANAL: PoiInput = {
  id: "horikawa-canal-nichinan",
  name: "Horikawa Canal",
  nameJa: "堀川運河",
  parentId: "nichinan-city",
  prefecture: "Miyazaki",
  ...
  description:
    "A historic canal built in the Edo period (1686) by the Obi Domain to transport timber. Today, its stone walls, traditional arched bridge (Horikawa Bridge), and nostalgic atmosphere make it a scenic spot in the Aburatsu area of Nichinan.",
  descriptionJa:
    "江戸時代（1686年）に飫肥藩によって木材運搬のために開削された歴史ある運河。美しい石垣やアーチ型の堀川橋など、ノスタルジックな風景が広がる日南市油津の景勝地です。",
  highlights: [
    "Walk across the historic arched stone Horikawa Bridge",
    "Admire the Edo-period stone walls lining the canal",
    "Enjoy the nostalgic atmosphere of the Aburatsu district",
  ],
  highlightsJa: [
    "アーチ型の石橋「堀川橋」を渡る",
    "江戸時代から残る運河の石垣を見学",
    "油津地区のノスタルジックな雰囲気を楽しむ",
  ],
  heroImage:
    "https://upload.wikimedia.org/wikipedia/commons/7/7a/Horikawa_canal_horikawa_bridge.jpg",
  ...
  crowd: { weekday: 2, weekend: 4, holiday: 5 },
  season: { spring: 8, summer: 7, autumn: 8, winter: 7 },
  bestMonths: [3, 4, 5, 9, 10, 11],
  weatherDependence: "medium",
  reservation: "None required",
  parking: "Public parking available nearby in Aburatsu",
  walkingIntensity: "low",
  walkingSunMin: 1000,
  walkingShadeMin: 0,
