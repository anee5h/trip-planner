...
describe("search index destination availability parity (KAI-93)", () => {
  it("indexes all 1056 recommendation-eligible canonical destination IDs identically across English and Japanese", async () => {
