...
describe("search index destination availability parity (KAI-93)", () => {
  it("indexes all 980 canonical destination IDs identically across English and Japanese", async () => {
