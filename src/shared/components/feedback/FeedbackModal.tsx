    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-md max-h-[90vh] sm:max-h-[85vh] m-4 sm:m-0 overflow-hidden animate-in fade-in zoom-in-95 duration-150 z-10 flex flex-col p-4 sm:p-6">
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 shrink-0">
          ...
          <button
            onClick={handleClose}
            className="p-2 rounded-full text-slate-500 hover:text-slate-600 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          {submitted ? (
            <div className="py-6 text-center space-y-4 animate-in fade-in duration-200">
              ...
              <div className="pt-2 flex flex-col gap-2">
                ...
                <Button
                  onClick={handleClose}
                  className="w-full bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs rounded-2xl py-2.5 shadow-sm"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-1.5 py-2 px-3 rounded-2xl text-xs font-bold border transition-all ${
                      feedbackType === "general"
                        ? "bg-emerald-50 dark:bg-emerald-950/60 border-emerald-700/50 text-emerald-700 dark:text-emerald-300 shadow-2xs"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-base sm:text-xs placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-700 resize-none transition-all"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                <Button
                  ...
                  variant="ghost"
                  onClick={handleClose}
                  className="text-xs text-slate-500 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-200 rounded-2xl"
                >
                ...
                <Button
                  ...
                  className="bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs rounded-2xl px-4 py-2 flex items-center gap-1.5 shadow-sm active:scale-95 transition-all"
                >
                  {isSubmitting ? (
                    <>
