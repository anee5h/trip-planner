 ...
 *
 * KAI-68: serves prerendered HTML for every manifest destination, a
 * localized noindex 404 for unknown ids, and a non-indexable 503 when a
 * manifest-listed prerendered asset is unavailable. Pages Functions take
 * precedence over _redirects, so the `/* /index.html 200` fallback never
 * masks destination errors.
 *
