...
Suite: `e2e/` — runs on every PR via `pr-checks.yml` (4 shards, KAI-99) and on
the default branch before releases. Fixtures: weather routes mocked, clock
pinned via `page.clock`; production data never used; guest sessions by default
(auth journeys need isolated fixtures — tracked in KAI-51 follow-ups).
...
| J3  | Search destinations from Home                       | ✅  | ✅  | ✅    | —    | ✅      | ✅     | kai-51-home-smoke                                                     | ✅                    |
| J4  | Locale switch EN⇄JA (all surfaces)                  | ✅  | ✅  | ✅    | —    | ✅      | ✅     | kai-49-destinations-ja, kai-51-home-smoke                             | ✅                    |
| J5  | Explore: grid + filters + sort                      | ✅  | 🟡  | ✅    | —    | ✅      | ✅     | kai-51-destinations-explore                                           | 🟡 (JA partial)       |
...
| J9  | Collections directory + detail                      | ✅  | 🟡  | ✅    | —    | ✅      | ✅     | kai-51-collections                                                    | 🟡 (JA partial)       |
...
- **J12/J14/J15 auth journeys** — require isolated Supabase test fixtures
