...
**The prefecture-pair / municipality-pair registry is sufficient as the *runtime lookup structure* but not as the *evidence model*.** It cannot truthfully express:
